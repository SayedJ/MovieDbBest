namespace webapp_cloudrun
{
    public class Comparer
{
    /// <summary>
    /// Creates an instance of Comparer using the specified projection.
    /// </summary>
    ...
    public static Comparer<TSource, TKey> Create<TSource, TKey>(Func<TSource, TKey> projection)
    {
        return new Comparer<TSource, TKey>(projection);
    }
    ...
    /// <returns>A comparer which will compare elements by projecting
    /// each element to its key, and comparing keys</returns>
    public static Comparer<TSource, TKey> Create<TSource, TKey>
        (TSource ignored,
...
/// </summary>
public static class Comparer<TSource>
{
    /// <summary>
    /// Creates an instance of Comparer using the specified projection.
    /// </summary>
    ...
    public static Comparer<TSource, TKey> Create<TKey>(Func<TSource, TKey> projection)
    {
        return new Comparer<TSource, TKey>(projection);
    }
}
...
public class Comparer<TSource, TKey> : IEqualityComparer<TSource>
{
    ...
    public Comparer(Func<TSource, TKey> projection)
    ...
    public Comparer(Func<TSource, TKey> projection, IEqualityComparer<TKey> comparer)
    {
        if (projection == null)
        {
